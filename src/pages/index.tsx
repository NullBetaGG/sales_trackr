...
export default function Home() {
  ...
  return (
    <div className="w-[99vw] pl-[7rem] pr-[3rem] flex justify-between mx-2 h-[90vh] mt-[-6rem]">
      ...
      <div>
        <div className="hover:border-[#888888] flex justify-center hover:scale-105 hover:border-[1px] transition-transform duration-300 bg-[#2d2d2d] hover:border-2px w-[25rem] h-[51rem] z-20 rounded-[1.5rem]">
      ...
      {/* <div className="mt-20">
        ...
        &nbsp;
        <span className="uppercase font-light text-[2rem] text-[#ff6600]">{component}</span>
        &nbsp;
        <span className="uppercase font-light text-[2rem]">component</span>
      </div> */}
    </div>
  )
}
